            ...
            <tbody>
                ...
                @foreach ($bookings as $booking)
                    <tr id="tr_{{ $booking->id }}">
                        ...
                        <td id="td_service_{{ $booking->id }}">{{ $booking->service->service_name }}</td>
...
@push('script')
    <script>
        function getEditForm(id) {
            $.ajax({
                type: 'POST',
                url: '{{ route("bookings.getEditForm") }}',
                data: {
        ...
        function saveDataUpdate(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("bookings.saveDataUpdate") }}',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id,
                    'user_id': user_id,
