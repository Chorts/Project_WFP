...
<head>
    ...
    <!-- apexcharts -->
    <link rel="stylesheet" href="{{asset('adminlte4/apexcharts.css')}}"
        integrity="sha256-4MX+61mt9NVvvuPjUWdUdyfZfxSB1/Rf9WtqRHgG5S0=" crossorigin="anonymous" />
    <!-- jsvectormap -->
    <link rel="stylesheet" href="{{asset('adminlte4/css/jsvectormap.min.css')}}"
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        @can('access-admin')
                            <li class="nav-item">
                                <a href="{{ route('admin.dashboard') }}" class="nav-link @yield('sidebar-dashboard')">
                        ...
                        @can('access-doctor')
                            ...
                            <li class="nav-item">
                                <a href="{{route('doctor.consultations.index')}}"
                                    class="nav-link @yield('sidebar-consultations')">
                                    <i class="nav-icon bi bi-speedometer"></i>
                                    <p>Consultations</p>
                                </a>
                            </li>
