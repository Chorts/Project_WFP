                ...
                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="tr_<?php echo e($doctor->id); ?>">
                        ...
                        <td id="td_specialization_<?php echo e($doctor->id); ?>"><?php echo e($doctor->specialization_id); ?> -
                            <?php echo e($doctor->specialization->name); ?></td>
                            <td>
...
<?php $__env->startPush('modals'); ?>
    ...
    <div class="modal fade" id="modalCreate" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="<?php echo e(url('/doctors')); ?>">
...
<?php $__env->startPush('script'); ?>
    <script>
        function getEditForm(id) {
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("doctors.getEditForm")); ?>',
                data: {
        ...
        function saveDataUpdate(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("doctors.saveDataUpdate")); ?>',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id,
                    'name': name,
        ...
        function deleteDataRemove(id) {
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("doctors.deleteData")); ?>',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id
                },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlte4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CENT\Downloads\Imp\Ubaya\Tugas\Sem 6\Web Framework Programming\Project_WFP\resources\views/doctors/index.blade.php ENDPATH**/ ?>