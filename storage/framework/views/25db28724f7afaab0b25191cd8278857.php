        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo e(route('doctor.consultations.show', $consultation->id)); ?>" class="btn btn-sm btn-primary">
                        Lihat Chat
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('doctor.consultations.show', $consultation->id)); ?>" class="btn btn-sm btn-primary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlte4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CENT\Downloads\Imp\Ubaya\Tugas\Sem 6\Web Framework Programming\Project_WFP\resources\views/doctor/consultations/index.blade.php ENDPATH**/ ?>