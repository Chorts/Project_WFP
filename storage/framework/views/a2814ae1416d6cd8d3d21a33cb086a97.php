...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('adminlte4/css/adminlte.css')); ?>" />
    <!--end::Required Plugin(AdminLTE)-->
    <!-- apexcharts -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte4/apexcharts.css')); ?>"
        integrity="sha256-4MX+61mt9NVvvuPjUWdUdyfZfxSB1/Rf9WtqRHgG5S0=" crossorigin="anonymous" />
    <!-- jsvectormap -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte4/css/jsvectormap.min.css')); ?>"
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="<?php echo e(asset('adminlte4/assets/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo"
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-admin')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo $__env->yieldContent('sidebar-dashboard'); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-doctor')): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('doctor.consultations.index')); ?>"
                                    class="nav-link <?php echo $__env->yieldContent('sidebar-consultations'); ?>">
                                    <i class="nav-icon bi bi-speedometer"></i>
                                    <p>Consultations</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('doctor.history.index')); ?>"
                                    class="nav-link <?php echo $__env->yieldContent('sidebar-consultations'); ?>">
                                    <i class="nav-icon bi bi-speedometer"></i>
    ...
    <script src="<?php echo e(asset('adminlte4/js/adminlte.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\enric\OneDrive\Desktop\Kuliah\Semester 6\WFP\Project_WFP\resources\views/layouts/adminlte4.blade.php ENDPATH**/ ?>