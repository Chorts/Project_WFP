...
<div class="container">
    ...
    <a href="<?php echo e(route('admin.services.create')); ?>" class="btn btn-primary">+ New Service</a>
    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr id="tr_<?php echo e($d->id); ?>">
                ...
                <td>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-permission', Auth::user())): ?>
                    <a href="<?php echo e(route('admin.services.edit', $d->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                    ...
                    <form action="<?php echo e(route('admin.services.destroy', $d->id)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
...
<script>
    function getEditForm(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.services.getEditForm")); ?>',
            data: {
    ...
    function getEditFormB(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.services.getEditFormB")); ?>',
            data: {
                '_token': '<?php echo csrf_token(); ?>',
                'id': id
            },
    ...
    function saveDataUpdate(id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.services.saveDataUpdate")); ?>',
            data: {
                '_token': '<?php echo csrf_token(); ?>',
                'id': id,
    ...
    function deleteDataRemove(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.services.deleteData")); ?>',
            data: {
                '_token': '<?php echo csrf_token(); ?>',
                'id': id
            },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlte4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wfp\PROJECT\Project_WFP-main\resources\views/admin/services/index.blade.php ENDPATH**/ ?>