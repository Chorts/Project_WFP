...
<form method="POST" action="<?php echo e(route('services.update', $data->id)); ?>">
    <?php echo csrf_field(); ?>
...
</form><?php /**PATH C:\xampp\htdocs\wfp\Project UTS\Project_WFP\resources\views/services/getEditForm.blade.php ENDPATH**/ ?>