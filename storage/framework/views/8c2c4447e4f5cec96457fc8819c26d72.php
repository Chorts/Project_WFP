...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('member.bookings.create')); ?>" class="btn btn-primary">
            Booking Baru
        </a>
    </div>
...
<?php echo $__env->make('layouts.member', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wfp\PROJECT\Project_WFP-main\resources\views/member/bookings/index.blade.php ENDPATH**/ ?>