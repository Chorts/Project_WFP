...
<div class="modal fade" id="modalCreate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="<?php echo e(route('admin.bookings.store')); ?>">
...
<script>
    function getEditForm(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.bookings.getEditForm")); ?>',
            data: {
    ...
    function saveDataUpdate(id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.bookings.saveDataUpdate")); ?>',
            data: {
                '_token': '<?php echo csrf_token(); ?>',
                'id': id,
                'user_id': user_id,
    ...
    function deleteDataRemove(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("admin.bookings.deleteData")); ?>',
            data: {
                '_token': '<?php echo csrf_token(); ?>',
                'id': id
            },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlte4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CENT\Downloads\Imp\Ubaya\Tugas\Sem 6\Web Framework Programming\Project_WFP\resources\views/admin/bookings/index.blade.php ENDPATH**/ ?>