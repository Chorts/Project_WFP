                    ...
                    <tr id="tr_<?php echo e($article->id); ?>">
                        ...
                        <td>
                            <a href="#modalEdit" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                onclick="getEditForm(<?php echo e($article->id); ?>)">Edit</a>

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-permission', Auth::user())): ?>
                                <a href="#" class="btn btn-danger btn-sm"
                                    onclick="if(confirm('Are you sure to delete <?php echo e($article->id); ?> - <?php echo e($article->title); ?>?')) deleteDataRemove(<?php echo e($article->id); ?>)">
                                    Delete
                                </a>
                            <?php endif; ?>
                        </td>
...
<?php $__env->startPush('script'); ?>
    <script>
        function getEditForm(id) {
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("articles.getEditForm")); ?>',
                data: {
        ...
        function saveDataUpdate(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("articles.saveDataUpdate")); ?>',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id,
                    'title': title,
        ...
        function deleteDataRemove(id) {
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("articles.deleteData")); ?>',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id
                },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminlte4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CENT\Downloads\Imp\Ubaya\Tugas\Sem 6\Web Framework Programming\Project_WFP\resources\views/articles/index.blade.php ENDPATH**/ ?>